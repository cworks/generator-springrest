...
public final class GZipResponseUtil {
     ...
     * @throws net.cworks.app.web.filter.gzip.GzipResponseHeadersNotModifiableException Either the response is committed or we were called using the include method
