...
import net.cworks.app.async.AsyncExecutor;
...
public class AsyncConfiguration implements AsyncConfigurer, EnvironmentAware {
    ...
    /**
     * Create the Executor to be used when processing async task requests
     * @return
     */
    @Override
    @Bean
    public Executor getAsyncExecutor() {
        ...
        // TODO threadNamePrefix should be paramertized
        executor.setThreadNamePrefix("springrest-Executor-");
