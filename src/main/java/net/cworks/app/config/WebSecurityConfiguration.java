...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter
     ...
     */
    private static final String REALM = "SpringRestSecurityRealm";
    ...
    public DigestAuthenticationEntryPoint digestEntryPoint () {
        ...
        entryPoint.setKey("onefishtwofishredfishbluefish");
    ...
    protected void configureBasicAuth(HttpSecurity http) throws Exception {
        http.exceptionHandling().authenticationEntryPoint(basicEntryPoint())
                ...
                .and()
                .authorizeRequests().antMatchers("/app/rest/**").authenticated()
                .and()
                .csrf().disable()
                .httpBasic();
    }
